...
Использование MLflow позволяет сравнивать модели, анализировать завимость между гиперпаарметрами и метриками, отслеживать изменения качества между экспериментами. Это позволяет сохранять последовательность проводимых экспериментов и воспроизвести необходимую версию модели. 
